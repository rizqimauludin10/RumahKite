...
public class TukangFormActivity extends AppCompatActivity implements StepperLayout.StepperListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        justifiedTextView = (JustifiedTextView) findViewById(R.id.descThree);
        justifiedTextView = (JustifiedTextView) findViewById(R.id.descFive);
        justifiedTextView = (JustifiedTextView) findViewById(R.id.descSix);
        justifiedTextView = (JustifiedTextView) findViewById(R.id.descSeven);
        justifiedTextView = (JustifiedTextView) findViewById(R.id.descEight);
